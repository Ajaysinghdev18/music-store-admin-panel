...
import { RoundedButton, Table as BidderList } from '../../../components';
...
import { ArrowLeftIcon, ContainedKYCIcon, OutlinedKYCIcon } from '../../../assets/icons';
// Components
import { ConfirmDialog, Dropzone, IColumn } from '../../../components';
          ...
          <CardHeader
            ...
            action={
              <Stack direction="row" spacing={16}>
                {product?.isAuction ? <S.EditButton size="medium" disabled={isBidder} onClick={() => handleAuction(!product?.isAuction)}>
                  Close For Sale
                </S.EditButton> : <S.EditButton size="medium" onClick={() => handleAuction(!product?.isAuction)}>
                  Open For Sale
                </S.EditButton>}
