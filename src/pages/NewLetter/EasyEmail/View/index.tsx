...
export default function EasyNewsLetterView(id: any) {
  ...
  useEffect(() => {
    NewsLetterApi.getNewsLetterById(id.id)
      .then((res) => {
        setTemplateData(res.newsLetter);
        setTemplate({
          subject: res.newsLetter.subject,
          subTitle: res.newsLetter.description,
          content: JSON.parse(res.newsLetter.contentJSON)
        });
        setTemplateName(res.newsLetter.title);
      })
