...
export const PhysicalImageForm = ({
  setGallery,
  gallery,
  artist,
  product,
  ...
  const handleCancel = () => {
    navigate(ROUTES.PHYSICAL_PRODUCT.LIST);
  };
    ...
    <Fragment>
      ...
      <Stack direction="row" spacing={48}>
        <Stack spacing={16} sx={{ flex: 1 }}>
          ...
          {/*    <FormControl fullWidth>*/}
          {/*        /!* @ts-ignore *!/*/}
          {/*        <InputLabel variant="alone">PREPARE PRODUCT AS PHYSICAL</InputLabel>*/}
                  ...
                  <Dropzone
                    ...
                    videoSrc={
                      values.video?.fieldname
                        ? `${REACT_APP_API_ASSETS_SERVER}/${values.video?.fieldname}/${values.video?.filename}?timestamp=${Date.now()}`
                        : values.video
      ...
      <Box display="flex" justifyContent="flex-end" alignItems="center" mt={2}>
        <Stack direction="row" spacing={16} paddingTop={16}>
