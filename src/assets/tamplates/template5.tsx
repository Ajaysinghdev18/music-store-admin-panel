    ...
    <svg xmlns="http://www.w3.org/2000/svg" id="Template5" width={width} height={height} viewBox="0 0 1690 420">
      ...
      <g id="Mask_Group_43" data-name="Mask Group 43" transform="translate(-115 -330)" clip-path="url(#clip-path)">
        ...
        <line
          ...
          data-name="Line 159"
          y2="336"
          transform="translate(1385 372.5)"
          fill="none"
          stroke="blue"
          stroke-width="5"
          stroke-dasharray="24 2"
        />
        <g id="Group_1133" data-name="Group 1133" transform="translate(-170)">
          <path
            id="Subtraction_44"
            data-name="Subtraction 44"
            d="M119.6,80H40.009A40.044,40.044,0,0,0,80,40a40.125,40.125,0,0,0,39.6,40Z"
            transform="translate(244.991 670)"
            fill="blue"
          />
          <path
            id="Subtraction_45"
            data-name="Subtraction 45"
            d="M79.588,0H0A39.722,39.722,0,0,1,28.264,11.729,39.731,39.731,0,0,1,39.992,40a40.124,40.124,0,0,1,39.6-40Z"
        ...
        <path
          ...
          d="M0,0H0A16,16,0,0,1,16,16v88A16,16,0,0,1,0,120H0a0,0,0,0,1,0,0V0A0,0,0,0,1,0,0Z"
          transform="translate(115 480)"
          fill="blue"
        />
        <text
        ...
        <g id="Group_1134" data-name="Group 1134">
          <g id="Mask_Group_36" data-name="Mask Group 36" transform="translate(-178 -20)" clip-path="url(#clip-path-3)">
            <image
              ...
              width="597.919"
              height="298.96"
              transform="translate(1022 410.002)"
              xlinkHref={base64 ? base64 : iconBase64}
            />
          </g>
          <text
            id="Music_on_Rhoon_Festival"
            data-name="Music on Rhoon Festival"
            transform="translate(215 423)"
            font-size="80"
            font-family="Gemunu Libre"
            font-weight="800"
          ...
          <text
            id="Music_on_Rhoon_Festival-2"
            data-name="Music on Rhoon Festival"
            transform="translate(1415 690) rotate(-90)"
            font-size="40"
            font-family="Gemunu Libre"
            font-weight="800"
            letter-spacing="-0.08em"
...
June 25 2022
14:30 to 01:00 (CEST)"
            transform="translate(1591 690) rotate(-90)"
            font-size="30"
            font-family="Gemunu Libre"
            font-weight="200"
            letter-spacing="-0.08em"
          >
            <tspan x="0" y="27">
              {startTime ? moment(startTime).format('MMMM Do YYYY, h:mm:ss a') : 'Event Date Here'}
            </tspan>
          </text>
          <text
...
Metaverse"
          ...
          <text
            id="Saturday_June_25_2022_14:30_to_01:00_CEST_2"
            data-name="Saturday
June 25 2022
14:30 to 01:00 (CEST)"
            transform="translate(1124 597)"
            font-size="30"
            font-family="Gemunu Libre"
            font-weight="800"
            letter-spacing="-0.08em"
        ...
        <g
          ...
          transform="translate(1787 308.586)"
        ...
        <rect
          ...
          width="111"
          height="489"
          transform="translate(279.686 236.508) rotate(30)"
        ...
        <rect
          ...
          width="111"
          height="489"
          transform="translate(186.686 102.508) rotate(30)"
          fill="#f0f"
          style={{ mixBlendMode: 'overlay', isolation: 'isolate' }}
        />
        <rect
          ...
          width="111"
          height="489"
          transform="translate(1246.971 808.986) rotate(-150)"
          fill="url(#linear-gradient)"
          style={{ mixBlendMode: 'overlay', isolation: 'isolate' }}
        />
        <rect
          ...
          width="207"
          height="647"
          transform="translate(755.91 878.02) rotate(-150)"
          opacity="0.74"
          fill="url(#linear-gradient)"
          style={{ mixBlendMode: 'overlay', isolation: 'isolate' }}
        />
        <rect
          ...
          width="111"
          height="489"
          transform="translate(1626.971 828.986) rotate(-150)"
        ...
        <rect
          ...
          width="134"
          height="489"
          transform="translate(1725.047 840.486) rotate(-150)"
          fill="#ff0"
          style={{ mixBlendMode: 'overlay', isolation: 'isolate' }}
        />
        <rect
          ...
          width="111"
          height="489"
          transform="translate(450 147.508) rotate(30)"
        ...
        <rect
          ...
          width="33.092"
          height="489"
          transform="translate(1061.5 817.494) rotate(-150)"
          opacity="0.6"
        ...
        <rect
          ...
          width="49.254"
          height="673.631"
          transform="translate(1800.344 -68.01) rotate(30)"
          opacity="0.9"
          fill="url(#linear-gradient-6)"
          style={{ mixBlendMode: 'overlay', isolation: 'isolate' }}
        />
        <rect
          ...
          width="13.059"
          height="627"
          transform="translate(818.65 810.256) rotate(-150)"
          opacity="0.6"
          fill="url(#linear-gradient-6)"
          style={{ mixBlendMode: 'overlay', isolation: 'isolate' }}
        />
        <rect
          ...
          width="51.059"
          height="627"
          transform="translate(787.65 797.256) rotate(-150)"
          opacity="0.33"
          fill="url(#linear-gradient-6)"
          style={{ mixBlendMode: 'overlay', isolation: 'isolate' }}
        />
        <rect
          ...
          width="51.059"
          height="627"
          transform="translate(178.719 797.256) rotate(-150)"
          opacity="0.44"
          fill="url(#linear-gradient-6)"
          style={{ mixBlendMode: 'overlay', isolation: 'isolate' }}
        />
        <rect
          ...
          width="69.092"
          height="489"
          transform="translate(1082.677 906.018) rotate(-150)"
